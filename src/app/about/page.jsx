  ...
  return (
    <div className="min-h-screen bg-[#FFFDE7] text-neutral-900">
      ...
      <section className="mx-auto max-w-4xl px-6 pt-10">
        <article
          className="relative rounded-2xl border border-neutral-200 bg-[#FFFDE7] p-6 shadow-sm sm:p-10"
        ...
        >
          ...
          <header className="grid grid-cols-1 items-start gap-4 sm:grid-cols-[1fr_auto]">
            <div>
              <h2 id="term" className="font-serif text-4xl sm:text-5xl">
                <span className="mr-2 inline-block rounded-md bg-neutral-900 px-2 py-1 font-serif text-sm font-semibold uppercase tracking-widest text-white">per·e·gri·nate</span>
              </h2>
              <div className="mt-2 font-serif flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-neutral-600">
            ...
            <div className="text-right sm:pt-2">
              <span className="rounded-full bg-neutral-100 px-3 py-1 text-xs font-medium tracking-wide text-neutral-700">
                \ˈpe-rə-grə-ˌnāt\
              </span>
            </div>
          </header>
          ...
          <ol className="space-y-4 pl-5 [counter-reset:step]">
            <li className="relative pl-6">
              ...
              <p className="max-w-prose font-serif leading-relaxed text-neutral-800 pl-2">
          ...
          <section className="mt-8">
            <h3 className="font-serif text-xs font-semibold uppercase tracking-widest text-neutral-600">
              Our Mission
            </h3>
            <p className="mt-2 font-serif text-neutral-800">
